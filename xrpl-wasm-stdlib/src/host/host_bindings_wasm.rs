...
mod host_defined_functions {
    ...
    unsafe extern "C" {
        pub(super) fn get_ledger_sqn() -> i64;
        pub(super) fn get_parent_ledger_time() -> i64;
        pub(super) fn get_parent_ledger_hash(out_buff_ptr: *mut u8, out_buff_len: usize) -> i32;
        pub(super) fn get_base_fee() -> i64;
        ...
        pub(super) fn get_nft_taxon(nft_id_ptr: *const u8, nft_id_len: usize) -> i64;
        ...
        pub(super) fn get_nft_serial(nft_id_ptr: *const u8, nft_id_len: usize) -> i64;
