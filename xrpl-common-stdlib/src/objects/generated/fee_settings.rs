...
mod tests {
    ...
    fn read_all_fields() {
        ...
        assert!(obj.base_fee().is_ok());
        assert!(obj.reference_fee_units().is_ok());
        assert!(obj.reserve_base().is_ok());
        assert!(obj.reserve_increment().is_ok());
    ...
    fn optional_fields_none() {
        ...
        assert!(obj.base_fee().unwrap().is_none());
