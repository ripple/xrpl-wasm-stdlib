...
pub trait NFTokenOfferFields: LedgerObjectCommonFields {
    ...
    fn nftoken_id(&self) -> Result<Hash256> {
...
mod tests {
    ...
    fn read_all_fields() {
        ...
        assert!(obj.nftoken_offer_node().is_ok());
    ...
    fn optional_fields_none() {
        ...
        assert!(obj.destination().unwrap().is_none());
