...
pub const GasLimit: SField<u32, 131147> = SField::new();
pub const BytecodeSizeLimit: SField<u32, 131148> = SField::new();
pub const GasPrice: SField<u32, 131149> = SField::new();
pub const Gas: SField<u32, 131150> = SField::new();
pub const GasUsed: SField<u32, 131151> = SField::new();
pub const ParameterFlag: SField<u32, 131152> = SField::new();
...
pub const LoanScale: SField<Unmapped, 655361> = SField::new();
pub const RemainingOwnerCountDelta: SField<Unmapped, 655362> = SField::new();
pub const VMReturnCode: SField<Unmapped, 655363> = SField::new();
