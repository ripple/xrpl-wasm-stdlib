...
pub const GasLimit: SField<u32, 131149> = SField::new();
pub const BytecodeSizeLimit: SField<u32, 131150> = SField::new();
pub const GasPrice: SField<u32, 131151> = SField::new();
pub const Gas: SField<u32, 131152> = SField::new();
pub const GasUsed: SField<u32, 131153> = SField::new();
