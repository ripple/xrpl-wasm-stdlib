...
/// [`Locator`](crate::fields::locator::Locator) path segment. What it can't do is decode:
...
pub const ImmutableFlags: SField<u32, 131125> = SField::new();
...
pub const ConfidentialBalanceVersion: SField<u32, 131141> = SField::new();
pub const SponsoredOwnerCount: SField<u32, 131142> = SField::new();
pub const SponsoringOwnerCount: SField<u32, 131143> = SField::new();
pub const SponsoringAccountCount: SField<u32, 131144> = SField::new();
pub const RemainingOwnerCount: SField<u32, 131145> = SField::new();
pub const SponsorFlags: SField<u32, 131146> = SField::new();
pub const SubscriptionDate: SField<u32, 131147> = SField::new();
pub const RedemptionDate: SField<u32, 131148> = SField::new();
pub const IssuerKeyEpoch: SField<u32, 131149> = SField::new();
pub const AuditorKeyEpoch: SField<u32, 131150> = SField::new();
pub const IssuerKeyMirrorEpoch: SField<u32, 131151> = SField::new();
pub const AuditorKeyMirrorEpoch: SField<u32, 131152> = SField::new();
pub const GasLimit: SField<u32, 131153> = SField::new();
pub const BytecodeSizeLimit: SField<u32, 131154> = SField::new();
pub const GasPrice: SField<u32, 131155> = SField::new();
pub const Gas: SField<u32, 131156> = SField::new();
pub const GasUsed: SField<u32, 131157> = SField::new();
pub const ParameterFlag: SField<u32, 131158> = SField::new();
...
pub const ConfidentialOutstandingAmount: SField<u64, 196640> = SField::new();
pub const SponseeNode: SField<u64, 196641> = SField::new();
...
pub const ReferenceHolding: SField<Hash256, 327719> = SField::new();
pub const BlindingFactor: SField<Hash256, 327720> = SField::new();
pub const ObjectID: SField<Hash256, 327721> = SField::new();
pub const ContractHash: SField<Hash256, 327722> = SField::new();
pub const ContractID: SField<Hash256, 327723> = SField::new();
...
pub const FeeAmount: SField<Amount, 393248> = SField::new();
pub const MaxFee: SField<Amount, 393249> = SField::new();
pub const FeeAmountDelta: SField<Amount, 393250> = SField::new();
...
pub const ConfidentialBalanceInbox: SField<StandardBlob, 458784> = SField::new();
pub const ConfidentialBalanceSpending: SField<StandardBlob, 458785> = SField::new();
pub const IssuerEncryptedBalance: SField<StandardBlob, 458786> = SField::new();
pub const IssuerEncryptionKey: SField<StandardBlob, 458787> = SField::new();
pub const HolderEncryptionKey: SField<StandardBlob, 458788> = SField::new();
pub const ZKProof: SField<StandardBlob, 458789> = SField::new();
pub const HolderEncryptedAmount: SField<StandardBlob, 458790> = SField::new();
pub const IssuerEncryptedAmount: SField<StandardBlob, 458791> = SField::new();
pub const SenderEncryptedAmount: SField<StandardBlob, 458792> = SField::new();
pub const DestinationEncryptedAmount: SField<StandardBlob, 458793> = SField::new();
pub const AuditorEncryptedBalance: SField<StandardBlob, 458794> = SField::new();
pub const AuditorEncryptedAmount: SField<StandardBlob, 458795> = SField::new();
pub const AuditorEncryptionKey: SField<StandardBlob, 458796> = SField::new();
pub const AmountCommitment: SField<StandardBlob, 458797> = SField::new();
pub const BalanceCommitment: SField<StandardBlob, 458798> = SField::new();
pub const Bytecode: SField<WasmBlob, 458799> = SField::new();
pub const ContractCode: SField<StandardBlob, 458800> = SField::new();
pub const FunctionName: SField<StandardBlob, 458801> = SField::new();
...
pub const Sponsor: SField<AccountID, 524315> = SField::new();
pub const HighSponsor: SField<AccountID, 524316> = SField::new();
pub const LowSponsor: SField<AccountID, 524317> = SField::new();
pub const CounterpartySponsor: SField<AccountID, 524318> = SField::new();
pub const Sponsee: SField<AccountID, 524319> = SField::new();
pub const ContractAccount: SField<AccountID, 524320> = SField::new();
pub const Number: SField<Number, 589825> = SField::new();
pub const AssetsAvailable: SField<Number, 589826> = SField::new();
pub const AssetsMaximum: SField<Number, 589827> = SField::new();
pub const AssetsTotal: SField<Number, 589828> = SField::new();
pub const LossUnrealized: SField<Number, 589829> = SField::new();
pub const DebtTotal: SField<Number, 589830> = SField::new();
pub const DebtMaximum: SField<Number, 589831> = SField::new();
pub const CoverAvailable: SField<Number, 589832> = SField::new();
pub const LoanOriginationFee: SField<Number, 589833> = SField::new();
pub const LoanServiceFee: SField<Number, 589834> = SField::new();
pub const LatePaymentFee: SField<Number, 589835> = SField::new();
pub const ClosePaymentFee: SField<Number, 589836> = SField::new();
pub const PrincipalOutstanding: SField<Number, 589837> = SField::new();
pub const PrincipalRequested: SField<Number, 589838> = SField::new();
pub const TotalValueOutstanding: SField<Number, 589839> = SField::new();
pub const PeriodicPayment: SField<Number, 589840> = SField::new();
pub const ManagementFeeOutstanding: SField<Number, 589841> = SField::new();
pub const LoanScale: SField<i32, 655361> = SField::new();
pub const RemainingOwnerCountDelta: SField<i32, 655362> = SField::new();
pub const VMReturnCode: SField<i32, 655363> = SField::new();
...
pub const SponsorSignature: SField<Object, 917542> = SField::new();
pub const Function: SField<Object, 917543> = SField::new();
pub const InstanceParameter: SField<Object, 917544> = SField::new();
pub const InstanceParameterValue: SField<Object, 917545> = SField::new();
pub const Parameter: SField<Object, 917546> = SField::new();
...
pub const LEVersion: SField<u8, 1048582> = SField::new();
...
pub const VaultKind: SField<u8, 1048598> = SField::new();
...
pub const Paths: SField<Unmapped, 1179649> = SField::new();
pub const Indexes: SField<Unmapped, 1245185> = SField::new();
pub const Hashes: SField<Unmapped, 1245186> = SField::new();
...
pub const XChainBridge: SField<Unmapped, 1638401> = SField::new();
pub const BaseAsset: SField<Currency, 1703937> = SField::new();
pub const QuoteAsset: SField<Currency, 1703938> = SField::new();
pub const ParameterValue: SField<Unmapped, 1769473> = SField::new();
pub const ParameterType: SField<Unmapped, 1835009> = SField::new();
pub const ContractJson: SField<Unmapped, 1900545> = SField::new();
pub const Transaction: SField<Unmapped, 655425793> = SField::new();
pub const LedgerEntry: SField<Unmapped, 655491329> = SField::new();
pub const Validation: SField<Unmapped, 655556865> = SField::new();
pub const Metadata: SField<Unmapped, 655622401> = SField::new();
