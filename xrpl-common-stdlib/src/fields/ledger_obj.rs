...
//! [`cache_le`](crate::objects::cache_le)). `get_field` and `get_field_optional` are generic over
//! any type implementing [`crate::fields::decoder::FromLedger`] — see [`crate::fields::decoder`]
//! for how a type opts into that.
